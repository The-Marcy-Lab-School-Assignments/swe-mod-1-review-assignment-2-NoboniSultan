...
console.log("Popular Book Titles", popularBookTitles);
...
const mostCheckouts = books.reduce((max, book) => book.checkouts > max ? book.checkouts : max, 0);
console.log("Most Checkouts:", mostCheckouts);